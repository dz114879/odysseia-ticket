...
def build_draft_welcome_embed(*, category_name: str) -> discord.Embed:
    description = (
        "目前 Ticket 处于草稿阶段，您有**最多 24 小时**来详细描述情况。"
        ...
        "⚠️ 如果您在6小时内，没有在本Ticket频道发送任何消息，本 Ticket 将被自动废弃；\n"
        "⚠️ 如果您在24小时内未将草稿正式提交，本 Ticket 将被自动废弃。"
    )
